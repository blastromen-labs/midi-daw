<template>
  <div class="pattern-menu flex-shrink-0 flex flex-col items-center gap-px" ref="rootRef">
    <div class="flex items-center gap-0.5">
      <button
        type="button"
        class="w-7 h-7 rounded flex items-center justify-center text-[9px] leading-none flex-shrink-0 transition-colors disabled:opacity-30 disabled:pointer-events-none"
